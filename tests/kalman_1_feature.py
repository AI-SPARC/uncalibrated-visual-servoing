...
Z_camera = robot.getCameraHeight(recalculate_fkine=True) # Considering fixed Z
focal = 1/(0.5/resolution[0])
J_image = np.zeros((len(f), 6)) # need to find
J_image[0, 0] = -focal/Z_camera
J_image[1, 1] = -focal/Z_camera
J_image[0, 2] = u/Z_camera
J_image[1, 2] = v/Z_camera
